...
const VaccinationData = (props) => {
  const host = "https://final-tpob.onrender.com/"
    ...
    const fetchallcenters = async()=>{
        const response = await fetch(`${host}auth/user/displaycenter`, {
            method: 'POST',
            headers: {
    ...
    const addcenter = async (name, place,dosage) => {
        const response = await fetch(`${host}auth/admin/addcenter`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
      ...
      const deletecenter = async (id) => {
        const response = await fetch(`${host}auth/admin/deletecenter/${id}`, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
            'mode': 'no-cors',
      ...
      const applyforslot = async (id) => {
        const response = await fetch(`${host}auth/user/applyforslot/${id}`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'mode': 'no-cors',
      ...
      const loginUser = async () => {
        ...
        const response = await fetch(`${host}auth/user/loginuser"`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const AddUser = async () => {
      ...
      const response = await fetch(`${host}auth/user/adduser`, {
